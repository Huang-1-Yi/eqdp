...
from eqdp.model.common.module_attr_mixin import ModuleAttrMixin # 混合类，它可能包含了一些与 PyTorch 模块相关的额外属性和方法，用于扩展 BaseImagePolicy 类的功能
from eqdp.model.common.normalizer import LinearNormalizer       # 用于数据标准化的类，它可能定义了如何将输入数据转换为具有特定均值和标准差的分布，这通常是为了提高模型训练的稳定性和性能
